...
export const exercises: Exercise[] = [
  {
    ...
    isPlyometric: true,
    targetMetrics: ['Cadence', 'Foot Angle', 'Vertical Oscillation'],
    targetInjuries: [],
    difficulty: 1,
  ...
  },
  {
    ...
    muscles: 'Neuromuscular patterns for proper gait, Quads, hamstrings, Calves',
    isPlyometric: true,
    targetMetrics: ['Cadence', 'Foot Angle', 'Lean', 'Vertical Oscillation'],
    targetInjuries: [],
    difficulty: 2,
  ...
  },
  {
    ...
    muscles: 'Neuromuscular patterns for proper gait, Quads, hamstrings, Calves',
    isPlyometric: false,
    targetMetrics: ['Foot Angle', 'Cadence', 'Vertical Oscillation'],
    targetInjuries: [],
    difficulty: 1,
  ...
  },
  {
    ...
    isPlyometric: false,
    targetMetrics: ['Swing (MSA)', 'Strike Angle (Shank Angle)', 'Foot Angle', 'Cadence'],
